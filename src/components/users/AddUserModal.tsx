...
export function AddUserModal({ refetch }: { refetch: () => void }) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Only attempt to refetch the users list if current user is admin
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          onClick={() => setData({ email: "", username: "", password: "" })}
        >
          <Plus />
          New User
        </Button>
